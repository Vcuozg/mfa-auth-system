          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative mt-1.5">
                <input
                  className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 pr-12 text-white placeholder-slate-500 outline-none focus:border-violet-500/60 transition text-sm"
                      ...
                      >
                        <div
                          className={`w-1.5 h-1.5 rounded-full ${
                            r.test(password) ? "bg-emerald-400" : "bg-slate-600"
                          }`}
                        />
                        {r.label}
                      </div>
